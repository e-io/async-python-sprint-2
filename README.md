...
Документация по этому проекту доступна благодаря использованию документатора MkDocs.
 ...
 - Посмотреть документацию к этому проекту по второму спринту онлайн [e-io.github.io/async-python-sprint-2](https://e-io.github.io/async-python-sprint-2/how-to-guides/)
